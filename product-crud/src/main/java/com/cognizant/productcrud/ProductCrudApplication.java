...
public class ProductCrudApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		List<Product> products = Arrays.asList(
				...
				new Product(14L, "Chips - Doritos", dept3),
				new Product(15L, "Bread Base - Toscano", dept9),
				new Product(16L, "Jam - Marmalade, Orange", dept8),
				new Product(17L, "Cheese - Gouda Smoked", dept8),
				new Product(18L, "Mudslide", dept5),
				new Product(19L, "Wine - Shiraz Wolf Blass Premium", dept5),
				new Product(20L, "Beef - Ground Lean Fresh", dept6),
				new Product(21L, "Bread Cranberry Foccacia", dept9),
				new Product(22L, "Chivas Regal - 12 Year Old" , dept5),
				new Product(23L, "Muffin Batt - Blueberry Passion", dept3),
				new Product(24L, "Beans - Kidney White", dept1),
				new Product(25L, "Pepper - Green, Chili", dept1),
				new Product(26L, "Cheese - Le Cheve Noir", dept8)
		);
